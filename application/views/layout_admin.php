    ...
    <div class="main-wrapper">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block">Hi, RZDzaky </div></a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="<?php echo site_url('kurir'); ?>"><i class="fas fa-bicycle"></i><span>Kurir</span></a></li>

                  <li><a class="nav-link" href="<?php echo site_url('kota'); ?>"><i class="fas fa-map-marker-alt"></i><span>Kota</span></a></li>

                  <li><a class="nav-link" href="<?php echo site_url('ongkir'); ?>"><i class="fas fa-exclamation"></i><span>Ongkos Kirim</span></a></li>
                </ul>
              </li>

            <li><a class="nav-link" href="<?php echo site_url('member'); ?>"><i class="fas fa-user"></i><span>Member</span></a></li>

            <li><a class="nav-link" href="<?php echo site_url('toko'); ?>"><i class="fas fa-columns"></i><span>Toko</span></a></li>
          </ul>
        </aside>
      </div>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2018 <div class="bullet"></div> Design By <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">Nathan Anandalla P</a>
        </div>
